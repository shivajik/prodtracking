...
// import { useToast } from "@/hooks/use-toast";
// import { apiRequest, queryClient } from "@/lib/queryClient";
// import { Plus, Trash2, Link as LinkIcon, Edit } from "lucide-react";
// import type { Crop, Variety, CropVarietyUrl } from "@shared/schema";
// import { insertCropVarietyUrlSchema } from "@shared/schema";
...
// interface CropVarietyUrlManagementProps {
//   cropsWithVarieties?: CropWithVarieties[];
// }

// export default function CropVarietyUrlManagement({ cropsWithVarieties }: CropVarietyUrlManagementProps) {
//   const { toast } = useToast();
//   const [showAddUrlDialog, setShowAddUrlDialog] = useState(false);
//   const [showEditUrlDialog, setShowEditUrlDialog] = useState(false);
//   const [selectedUrlForEdit, setSelectedUrlForEdit] = useState<CropVarietyUrl | null>(null);
...
//   cropsWithVarieties?: (Crop & { varieties: Variety[] })[];
// }

// export default function URLManagement({ cropsWithVarieties }: URLManagementProps) {
//   const { toast } = useToast();
//   const [showAddUrlDialog, setShowAddUrlDialog] = useState(false);
//   const [showEditUrlDialog, setShowEditUrlDialog] = useState(false);
//   const [selectedUrlForEdit, setSelectedUrlForEdit] = useState<CropVarietyUrl | null>(null);
